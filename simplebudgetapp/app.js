...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        // Exactly 2 decimal points an a comma seperating.
        ...
        int = numSplit[0];
        if(int.length>3) {
            int = int.substr(0,int.length-3) + ',' + int.substr(int.length-2,3);
        }
        dec = numSplit[1];
...
var controller = (function(budgetCtrl, UICtrl ) {
    ...
    return {
        init: function() {
            console.log('Nope did not worked on making it responsive.');
            UICtrl.displayMonth();
